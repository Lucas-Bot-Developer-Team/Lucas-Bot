...
namespace EleCho.GoCqHttpSdk
{
    ...
    public static class CqActionSessionExtensions
    {
        ...
        /// <param name="session">可发送操作的会话</param>
        /// <param name="groupId">群号</param>
        /// <param name="page">精华消息页数</param>
        /// <returns>用于等待结果的任务</returns>
        public static Task<CqGetEssenceMessageListActionResult?> GetEssenceMessageListAsync(this ICqActionSession session, long groupId, int page = 0) =>
            session.InvokeActionAsync<CqGetEssenceMessageListAction, CqGetEssenceMessageListActionResult>(new CqGetEssenceMessageListAction(groupId, page));
        ...
        /// <param name="groupId">群号</param>
        /// <returns>操作结果</returns>
        public static CqGetEssenceMessageListActionResult? GetEssenceMessageList(this ICqActionSession session, long groupId, int page = 0) =>
            GetEssenceMessageListAsync(session, groupId, page).Result;
