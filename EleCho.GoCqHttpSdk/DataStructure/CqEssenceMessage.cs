...
namespace EleCho.GoCqHttpSdk
{
    ...
    public record class CqEssenceMessage
    {
        ...
        [JsonConstructor]
        public CqEssenceMessage(long senderId, string senderNickname, long operatorId, string operatorNickname, long messageId, DateTime sendTime, DateTime operationTime, JsonArray messageContent)
        {
            SenderId = senderId;
        ...
        /// 消息内容（懒得写了，就这样）
        /// </summary>
        public JsonArray MessageContent { get; set; }
    }
}
