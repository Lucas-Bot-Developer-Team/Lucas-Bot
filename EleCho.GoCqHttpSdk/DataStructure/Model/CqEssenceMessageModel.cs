...
namespace EleCho.GoCqHttpSdk.DataStructure.Model
{
    ...
    {
        [JsonConstructor]
        public CqEssenceMessageModel(long sender_id, string sender_nick, long sender_time, long operator_id, string operator_nick, long operator_time, long message_id, JsonArray message_content)
        {
        ...
        public JsonArray message_content { get; }
    }
}
